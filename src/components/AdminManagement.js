            ...
            />
             <Modal  visible={modalRemoveVisible} transparent={true} onRequestClose={()=>{setModalRemoveVisible(false)}}>
                            <View style={[styles.modalContainer]}>
                               ...
                               {!checkOwner(selected)? <TouchableOpacity style={{width:100,height:40,backgroundColor:'red',borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={()=>{handleRemoveMember(selected)}}><Text>Xóa</Text></TouchableOpacity>:<></>}
